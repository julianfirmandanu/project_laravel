...
<h1>JavaScript Output</h1>
		...
		<!-- Small boxes (Stat box) -->
			...
			<div class='box box-primary'>
				...
				<p>JavaScript Display Possibilities
...
<li>into an HTML element, using innerHTML.</li>
<li>into an HTML element, using the value attribute.</li>
<li>into an HTML element, using the innerText property.</li>
<li>into an HTML element, using the textContent property.</li>
...
&lt;script&gt;<br>
document getElementById("demo").innerHTML = 5 + 6;f z is: " + z;<br>
&lt;/script&gt;<br>
